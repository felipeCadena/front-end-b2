  ...
  return (
    <section className="my-10">
      <div className="relative">
        <div className="flex items-center gap-3 bg-white mb-4">
          <MyIcon
            name="voltar-black"
          ...
          <div className="flex max-sm:flex-col items-start justify-between gap-8">
            <div className="">
              ...
              <div className="flex gap-2 items-center">
                ...
                <StarRating rating={activity.star} />
              </div>
            </div>
            <MyButton
              ...
              size="lg"
              className="font-bold text-[1rem] max-sm:hidden"
            >
      ...
      <div className="mx-6">
        ...
        <MyButton
          ...
          borderRadius="squared"
          size="lg"
          className="font-bold text-[1rem] w-full mt-6 md:hidden"
        >
          Falar com o parceiro
        </MyButton>
      </div>
