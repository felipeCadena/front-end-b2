  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 text-gray-800">
      <h1 className="text-2xl md:text-3xl font-bold mb-4">
        Termo de Serviço para Parceiros da Plataforma B2 Adventure
      </h1>
      ...
      <p className="mb-4">
        Este Termo de Serviço estabelece as condições para o cadastro e a
        participação de Parceiros na plataforma da B2 Adventure Sports Ltda,
        inscrita no CNPJ sob o nº 60.000.251/0001-06. Ao se cadastrar e utilizar
        a plataforma, o Parceiro declara estar de acordo com os termos e
        condições descritos abaixo, que regem a relação entre as partes.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">1. Definições</h2>
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ...
          atividades de aventura na plataforma B2 Adventure.
        </li>
        <li>
          <strong>Cliente:</strong> pessoa física ou jurídica que adquire
          atividades intermediadas pela B2 Adventure.
        </li>
      </ul>

      <h2 className="text-xl font-semibold mt-6 mb-2">
        2. Cadastro e Atividades na Plataforma
      </h2>
      <ul className="list-disc list-inside mb-4">
        <li>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">
        4. Chat e Comunicação com o Cliente
      </h2>
      <ul className="list-disc list-inside mb-4">
        <li>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">
        9. Regras de Conduta na Plataforma
      </h2>
      <ul className="list-disc list-inside mb-4">
        <li>
