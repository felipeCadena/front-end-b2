  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[&:not(:last-child)]:after:h-[2px] [&:not(:last-child)]:after:bg-neutral-200 [&:not(:last-child)]:after:content-['']",
        "data-[completed=true]:[&:not(:last-child)]:after:bg-primary-500",
        "data-[invalid=true]:[&:not(:last-child)]:after:bg-error-500",
        variant === "circle-alt" &&
          "[&:not(:last-child)]:after:z-1 flex-1 flex-col justify-start [&:not(:last-child)]:after:relative [&:not(:last-child)]:after:end-[50%] [&:not(:last-child)]:after:start-[50%] [&:not(:last-child)]:after:top-[calc(var(--step-icon-size)/3.5)] [&:not(:last-child)]:after:order-[-1] [&:not(:last-child)]:after:w-[calc((113%-var(--step-icon-size))-(var(--step-gap)))]",
        variant === "circle" &&
          "[&:not(:last-child)]:after:me-[var(--step-gap)] [&:not(:last-child)]:after:ms-[var(--step-gap)] [&:not(:last-child)]:after:flex-1",
        variant === "line" &&
          "flex-1 flex-col border-t-[3px] data-[active=true]:border-primary-500",
